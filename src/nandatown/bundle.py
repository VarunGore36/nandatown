...
# which reached main in 6adfd18; 0.3.0 and 0.4.0 in #264 and #279, 0.5.0
# in #281); Lab sim/validators.py (cb19e0e, 7af8084, d26ca5a, f4e85d7,
# 9f2e361, 6a697f2, de57461); Path path_runner.py (5aab66a, 64ecb5f,
# 2209bbf, d55b7e3). Add a version here when it merges.
#
...
SHIPPED_EVALUATOR_VERSIONS: dict[str, frozenset[str]] = {
    "track": frozenset({"0.2.0", "0.3.0", "0.4.0", "0.5.0"}),
